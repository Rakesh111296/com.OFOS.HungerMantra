...
public class Order_Dishes_from_two_different_Resturants {
	...
	public static void main(String[] args) throws Throwable {
		...
		String RestName1 = eUtil.readFromExcel("input", 0, 2);

		String DishName = eUtil.readFromExcel("input", 0, 3);
		String DishName1 = eUtil.readFromExcel("input", 1, 3);
		...
		mp.getChooseRestaurantLnk().click();

		rp.clickPaticularRestaurant(driver, RestName1);

		mp.clear_Add_Qty_And_Add_Cart(driver, DishName1);
