...
public class User_should_be_able_to_Cancel_the_Order_which_has_been_placed {
	...
	public static void main(String[] args) throws Throwable {
		...
		driver.findElement(By.xpath("(//a[.='Crispy Chicken Strips'])[1]/ancestor::div[@class='food-item']/descendant::input[@type='text']")).clear();
		...
		List<WebElement> BeforDeleting = driver.findElements(By.xpath("//th[.='Item']/following::tbody/descendant::td[@data-column='Item']"));
		int BeforeOrdCount = BeforDeleting.size();
		
		driver.findElement(By.xpath("(//td[.=' Kimchi'])[1]/../child::td/child::a[@class='btn btn-danger btn-flat btn-addon btn-xs m-b-10']")).click();
		al.accept();
		
		List<WebElement> AfterDeleting= driver.findElements(By.xpath("//th[.='Item']/following::tbody/descendant::td[@data-column='Item']"));
		int AfterDeletingCount = AfterDeleting.size();
		
		if (BeforeOrdCount>AfterDeletingCount) {
